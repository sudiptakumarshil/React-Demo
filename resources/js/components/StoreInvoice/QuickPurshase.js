...
class QuickPurshase extends Component {
    constructor(props) {
        super(props);
    ...
    getinvoiceNumber = async () => {
        ...
        if (idx == 5) {
            const response = await axios.get(
                defaultRouteLink + "/api/get-invoice-number-type-5"
            );
...
export default connect(mapStateToProps, { updateStoreInvoice })(QuickPurshase);
