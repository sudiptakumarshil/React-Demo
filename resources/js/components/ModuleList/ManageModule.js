...
const ManageModule = props => {
    ...
    const SaveInventCategory = async event => {
        ...
        const res = await axios.post(
            defaultRouteLink + "/api/save-module",
            data
        );
        // UPDATE STATE
        setRoot_id(root_id);
    ...
    const updateInventCategory = async event => {
        ...
        const res = await axios.patch(
            defaultRouteLink + `/api/update-module/${id}`,
            data
        );
    ...
    const deleteMenuSubmenu = async event => {
        ...
        const res = await axios.get(
            defaultRouteLink + `/api/delete-module/${id}`
        );
    ...
    const fetchAllmenuSubmenu = async () => {
        ...
        const res = await axios.get(
            defaultRouteLink + "/api/all-modulesubmodule"
        );
